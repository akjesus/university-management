...
import ViewAndActionStudent from "./pages/admin/course/ViewAndActionStudent";
      ...
      <HashRouter>
        <Routes>
          ...
          <Route
            ...
            element={
              instructorData ? <InstructorStudents /> : <InstructorLogin />
            }
          />
          <Route
          ...
          <Route
            ...
            element={
              instructorData ? <InstructorCourses /> : <InstructorLogin />
            }
          />
          <Route
            path="/instructor/settings"
            element={
              instructorData ? <InstructorSettings /> : <InstructorLogin />
            }
          />
          ...
          <Route
            path="/admin/students"
            element={adminData ? <ViewAndActionStudent/> : <AdminLogin />}
          />
          <Route
